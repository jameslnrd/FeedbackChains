...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"patching_rect" : [ 30.75, 913.0, 75.0, 22.0 ],
					"text" : "plugout~ 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 449.0, 328.5, 150.0, 20.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 449.0, 328.5, 150.0, 20.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 564.0, 406.0, 100.0, 22.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 564.0, 406.0, 62.0, 22.0 ],
					"text" : "live.banks"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1457.1312255859375, 289.699127197265625, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1423.0, 289.699127197265625, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 1440.1312255859375, 257.0, 36.0, 22.0 ],
					"text" : "sel 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1243.0, 189.199050903320313, 72.0, 22.0 ],
					"text" : "loadmess 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 1514.3687744140625, 303.199127197265625, 80.0, 13.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1509.0, 248.599563598632813, 43.0, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1358.0, 184.199050903320313, 276.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1440.1312255859375, 214.599533081054688, 53.0, 23.0 ],
					"triscale" : 0.9,
					"varname" : "number[15]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1327.5, 239.999984741210938, 100.0, 22.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1327.5, 189.199050903320313, 20.0, 20.0 ],
					"varname" : "button[5]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "int" ],
					"patching_rect" : [ 1327.5, 214.599533081054688, 103.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1347.5, 10.599533081054688, 282.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 1347.5, 100.599533081054688, 259.0, 25.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1327.5, 154.400466918945313, 53.0, 23.0 ],
					"triscale" : 0.9,
					"varname" : "number[14]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1327.5, 103.599533081054688, 20.0, 20.0 ],
					"varname" : "button[4]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1327.5, 13.599533081054688, 20.0, 20.0 ],
					"varname" : "button[3]"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1431.16748046875, 39.0, 53.0, 23.0 ],
					"triscale" : 0.9,
					"varname" : "number[13]"
				}
...
, 			{
				"box" : 				{
					"id" : "obj-136",
					"items" : [ "None", ",", "ad_asio", "Arturia ASIO Driver", ",", "ad_asio", "ASIO MADIface USB", ",", "ad_asio", "AudioBox ASIO Driver", ",", "ad_asio", "Generic Low Latency ASIO Driver", ",", "ad_asio", "iConnectivity ASIO Driver", ",", "ad_asio", "Realtek ASIO", ",", "ad_directsound", "", ",", "ad_mme", "", ",", "NonRealTime", ",", "ad_portaudio", "MME", ",", "ad_portaudio", "Windows DirectSound", ",", "ad_portaudio", "ASIO", ",", "ad_portaudio", "Windows WASAPI", ",", "ad_portaudio", "Windows WDM-KS", ",", "ad_rewire" ],
					"maxclass" : "umenu",
					"numinlets" : 1,
					"numoutlets" : 3,
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 1327.5, 64.400466918945313, 194.0, 22.0 ],
					"varname" : "umenu[2]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 1510.0, 275.599578857421875, 47.0, 22.0 ],
					"text" : "adc~ 1"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 1519.5, 298.0, 1523.8687744140625, 298.0 ],
					"order" : 1,
					"source" : [ "obj-32", 0 ]
				}
